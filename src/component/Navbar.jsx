import resume from '../assets/project/Mathesh-Resume.pdf';
export const Navbar = () => {
  return (
    <div className=" nav  backdrop-blur-sm w-screen fixed  h-20 top-0 left-0 right-0 bg-[rgba(255, 255, 255, 0)]  z-50 text-end pr-24 max-sm:pr-3 flex items-end flex-col justify-center">
      <a  href={resume} class="relative inline-flex items-center justify-center p-3 px-3 py-2 overflow-hidden font-medium  transition duration-300 ease-out border-2 border-white rounded-full shadow-md group">
        ...
        <span class="absolute flex items-center justify-center w-full h-full text-black bg-white transition-all duration-300 transform group-hover:translate-x-full ease">Resume</span>
